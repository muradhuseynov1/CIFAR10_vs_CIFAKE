...
def create_dataloaders(batch_size=32):
    ...
    #we started from what was working in densenet models and slightly modified it
    data_transforms = {
        'train': transforms.Compose([
            transforms.RandomHorizontalFlip(),
            transforms.RandomRotation(15),  
            transforms.ColorJitter(brightness=0.2, contrast=0.2, saturation=0.1, hue=0.01), #changed
            transforms.ToTensor(),
